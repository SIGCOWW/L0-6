...
ちなみにiPadのスタンドは@<img>{sigcoww_stand}の「Universal Tablet Station」、@<img>{stille_stand}のブレンド・Sに出てきたスタンドと同じなため、SIGCOWWはスティーレだったんですね。
//subfig[iPadスタンドの比較]{
//image[sigcoww_stand][SIGCOWWのiPadスタンド][scale=0.3]
//image[stille_stand][スティーレのiPadスタンド（ブレンド・S 8話より_©中山幸・芳文社／ブレンド・S製作委員会）][scale=0.65]
//}
...
//image[paypay_logo][PayPayアプリの決済履歴画面（決済番号は加工）][scale=0.5]
